...
En nuestro análisis anterior, elegimos **6 clústeres**. Esta elección se alinea con la sugerencia de este método, ya que después de 6, la mejora adicional en la inercia es marginal. La elección final puede depender también de la interpretabilidad y la utilidad de los segmentos resultantes para el contexto de negocio.
